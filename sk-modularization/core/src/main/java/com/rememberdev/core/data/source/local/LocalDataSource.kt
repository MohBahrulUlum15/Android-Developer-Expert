package com.rememberdev.core.data.source.local

import com.rememberdev.core.data.source.local.entity.TourismEntity
import com.rememberdev.core.data.source.local.room.TourismDao
