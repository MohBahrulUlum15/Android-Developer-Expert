package com.rememberdev.core.di

import androidx.room.Room
import com.rememberdev.core.data.source.local.LocalDataSource
import com.rememberdev.core.data.source.local.room.TourismDatabase
import com.rememberdev.core.data.source.remote.RemoteDataSource
import com.rememberdev.core.data.source.remote.network.ApiService
...
val repositoryModule = module {
    ...
    single<ITourismRepository> { com.rememberdev.core.data.TourismRepository(get(), get(), get()) }
}